...
@section('title','Clase de noticias nueva')
            ...
            <div class="card" style="margin-top:15px;">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{route('claseblogs.store')}}" method="POST">
                            @csrf
                            ...
                            <button type="submit" class="btn btn-primary mb-2">Enviar categoría de noticias</button>
