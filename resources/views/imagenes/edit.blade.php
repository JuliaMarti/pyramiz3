                    ...
                    @endif
                        ...
                        <form action="{{route('imagenes.update',$imagen)}}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    <label>Título</label>
                                    <input type="text" name="titulo" value="{{old('titulo',$imagen->titulo)}}" class="form-control" placeholder="Título">
                                </div>

                                <div class="form-group col-md-3">
                                    <label>Subtítulo</label>
                                    <input type="text" name="subtitulo" value="{{old('subtitulo',$imagen->subtitulo)}}" class="form-control" placeholder="Título">
                                </div>
                            ...
                            <div class="form-group">
                                <label>Texto</label>
                                <textarea class="form-control" name="texto" rows="3">{{old('texto',$imagen->texto)}}</textarea>
                            </div>
