            ...
            <div class="card" style="margin-top:15px;">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{route('infos.store', $descargable)}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    <label>Formato</label>
                                    <input type="text" name="formato" value="{{old('formato')}}" class="form-control" placeholder="Nombre">
                                </div>
                            ...
                            <div class="form-group">
                                <label>Archivo</label>
                                <input type="file" name="descarga" value="{{old('descarga')}}" class="form-control-file" >
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary mb-2">Enviar archivo</button>
